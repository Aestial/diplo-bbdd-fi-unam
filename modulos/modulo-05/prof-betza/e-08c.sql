...
--#TODO
drop tablespace if exists gbl_m05_enc_tbs including contents and datafiles;
create tablespace gbl_m05_enc_tbs
  datafile '/opt/oracle/oradata/FREE/gbl_m05_enc_tbs_01.dbf' size 20m
...
--#TODO
alter tablespace gbl_m05_enc_tbs encryption ONLINE encrypt;
--TODO#
...
--#TODO
drop user if exists c##betzabe05 cascade;
create user c##betzabe05 identified by betzabe;
grant create table, create session to c##betzabe05;
alter user c##betzabe05 quota unlimited on users container=current;
alter user c##betzabe05 quota unlimited on gbl_m05_enc_tbs container=current;
--TODO#

Prompt 8. Creando objetos y guardar sus datos en  el TS cifrado.
--#TODO
create table c##betzabe05.mensaje_seguro(
  id number,
  mensaje varchar2(20)
) tablespace gbl_m05_enc_tbs;

create index c##betzabe05.mensaje_seguro_ix on c##betzabe05.mensaje_seguro(mensaje)
tablespace gbl_m05_enc_tbs;

insert into c##betzabe05.mensaje_seguro (id, mensaje) values (1,'mensaje 1');
insert into c##betzabe05.mensaje_seguro (id, mensaje) values (2,'mensaje 2');
commit;
--TODO#
...
select * from c##betzabe05.mensaje_seguro;

Prompt 9. Crear la misma tabla  y datos pero en un TS no cifrado.
--#TODO
create table c##betzabe05.mensaje_inseguro(
  id number,
  mensaje varchar2(20)
) tablespace users;

create index c##betzabe05.mensaje_inseguro_ix on c##betzabe05.mensaje_inseguro(mensaje)
tablespace users;

insert into c##betzabe05.mensaje_inseguro (id, mensaje) values (1,'mensaje 1');
insert into c##betzabe05.mensaje_inseguro (id, mensaje) values (2,'mensaje 2');
commit;
...
--#TODO
!strings /opt/oracle/oradata/FREE/gbl_m05_enc_tbs_01.dbf | grep "mensaje"
--TODO#
