...
spool jrc-s-05-usuarios-admon-spool.txt
...
Prompt 2 Otorgar privilegios para crear tablas y sesiones a user01
...
connect user01/user01@jrcdiplo_s1
...
connect user01/user01@jrcdiplo_s1 as sysdba
pause ¿Qué usuario y esquema se asignan con esta autenticación?  Enter para continuar
Prompt usuario:
show user
Prompt esquema:
...
connect user01/user01@jrcdiplo_s1 as sysoper
pause ¿Qué usuario y esquema se asignan con esta autenticación?  Enter para continuar
Prompt usuario:
show user
Prompt esquema:
